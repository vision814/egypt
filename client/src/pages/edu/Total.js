...
import { listTotal } from "../../redux/actions/edu/edu";
import PropTypes from "prop-types";
import Tabs from "@mui/material/Tabs";
import Tab from "@mui/material/Tab";
import Box from "@mui/material/Box";
import SexLine from "../../component/chart/total/line/SexLine";
import SexBar from "../../component/chart/total/bar/SexBar";
import ResidenceBar from "../../component/chart/total/bar/ResidenceBar";
import ResidenceLine from "../../component/chart/total/line/ResidenceLine";
...
const Total = () => {
  ...
  const listTotalEduReducer = useSelector((state) => state.listTotalEduReducer);
  const { edu, error, loading } = listTotalEduReducer;
  ...
  const columnsDefs = [
    ...
    {
      headerName: "أقل من السن",
      field: "أقل من السن",
      sortable: true,
      filter: true,
    },
    {
      headerName: "جملة من التحق وتسرب من التعليم (4 سنوات فاكثر)",
      field: "جملة من التحق وتسرب من التعليم (4 سنوات فاكثر)",
      sortable: true,
      filter: true,
    },
    {
    ...
    {
      headerName: "التحق وتسرب",
      field: "التحق وتسرب",
      sortable: true,
      filter: true,
    },
    {
      headerName: "ملتحق حاليا",
      field: "ملتحق حاليا",
      sortable: true,
      filter: true,
    },
    {
      headerName: "التحق وانهى",
      field: "التحق وانهى",
      sortable: true,
      filter: true,
    },
        ...
        <>
          ...
          <Row>
            <Col>
              ...
              >
                جملة من التحق وتسرب من التعليم (4 سنوات فاكثر) 2017
              </Typography>
